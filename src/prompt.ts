...
- This project uses the Next.js App Router ONLY.
- You MUST NOT create a pages/ directory.
- You MUST NOT create pages/index.* under any circumstances.
- All routes MUST live under the app/ directory.
- The homepage MUST be implemented in app/page.tsx.
